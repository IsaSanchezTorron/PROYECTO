...
async function main() {
  ...
  await connection.query(`CREATE TABLE IF NOT EXISTS CONCURSOS (
  id_concurso INT PRIMARY AUTO_INCREMENT,
  nombre VARCHAR(100) PRIMARY KEY NOT NULL UNIQUE,
...
fecha_inscripcion DATETIME NOT NULL,
  ...
  await connection.query(`CREATE TABLE IF NOT EXISTS VALORACIONES (
