...
async function finishedConcourses(req, res, next) {
  ...
  try {
    ...
    const [result] = await connection.query(
      `SELECT CONCURSOS.nombre, CONCURSOS.descripcion, CONCURSOS.fecha_inicio, CONCURSOS.fecha_final, CONCURSOS.genero, CONCURSOS.modalidad, CONCURSOS.ciudad,  ROUND(AVG(INSCRIPCIONES.valoracion)) as valoracion
FROM CONCURSOS
